...
var require_browser = __commonJS({
  "node_modules/csvtojson/browser/browser.js"(exports, module) {
    module.exports = function(t) {
      ...
      function f(t2) {
        if (!(this instanceof f))
          return new f(t2);
        s.call(this, t2), a.call(this, t2), t2 && false === t2.readable && (this.readable = false), t2 && false === t2.writable && (this.writable = false), this.allowHalfOpen = true, t2 && false === t2.allowHalfOpen && (this.allowHalfOpen = false), this.once("end", h);
      }
      function h() {
      ...
      (function(t2) {
            ...
            if (i2 + f2 <= r2)
              switch (f2) {
                ...
                case 2:
                  ...
                  break;
                case 3:
                  o2 = t3[i2 + 1], s2 = t3[i2 + 2], 128 == (192 & o2) && 128 == (192 & s2) && (u2 = (15 & c2) << 12 | (63 & o2) << 6 | 63 & s2) > 2047 && (u2 < 55296 || u2 > 57343) && (l2 = u2);
                  break;
                case 4:
                  o2 = t3[i2 + 1], s2 = t3[i2 + 2], a2 = t3[i2 + 3], 128 == (192 & o2) && 128 == (192 & s2) && 128 == (192 & a2) && (u2 = (15 & c2) << 18 | (63 & o2) << 12 | (63 & s2) << 6 | 63 & a2) > 65535 && u2 < 1114112 && (l2 = u2);
              }
        ...
        u.prototype.slice = function(t3, e2) {
          ...
          for (this[e2] = 255 & t3; ++o2 < r2 && (s2 *= 256); )
            t3 < 0 && 0 === a2 && 0 !== this[e2 + o2 - 1] && (a2 = 1), this[e2 + o2] = (t3 / s2 >> 0) - a2 & 255;
          return e2 + r2;
      ...
      (function(e2, n, i) {
        ...
        c.inherits(m, h), y.prototype.getBuffer = function() {
          ...
          return s2 && !p.isBuffer(t2) && (t2 = function(t3) {
            return p.from(t3);
          }(t2)), "function" == typeof e3 && (r2 = e3, e3 = null), s2 ? e3 = "buffer" : e3 || (e3 = n2.defaultEncoding), "function" != typeof r2 && (r2 = v), n2.ended ? function(t3, e4) {
            var r3 = new Error("write after end");
            t3.emit("error", r3), o.nextTick(e4, r3);
          }(this, r2) : (s2 || function(t3, e4, r3, n3) {
            var i3 = true, s3 = false;
            return null === r3 ? s3 = new TypeError("May not write null values to stream") : "string" == typeof r3 || void 0 === r3 || e4.objectMode || (s3 = new TypeError("Invalid non-string/buffer chunk")), s3 && (t3.emit("error", s3), o.nextTick(n3, s3), i3 = false), i3;
      ...
      (function(e2, r2, n) {
        t.exports = function t2(e3, r3, n2) {
          ...
          for (var o = "function" == typeof _dereq_ && _dereq_, s = 0; s < n2.length; s++)
            i(n2[s]);
          return i;
        }({ 1: [function(t2, e3, r3) {
          "use strict";
          ...
          r3.exports = function(r4, n3) {
            ...
            function V(t3, e3, r5) {
              if ("undefined" != typeof console) {
                ...
                if (l.isObject(t3)) {
                  ...
                  n4 = e3 + String(t3);
                "function" == typeof s ? s(n4, r5) : "function" != typeof console.log && "object" != typeof console.log || console.log(n4);
              }
            }
            ...
            "undefined" != typeof console && void 0 !== console.warn && (s = function(t3) {
              console.warn(t3);
            }, l.isNode && e2.stderr.isTTY ? s = function(t3, e3) {
              var r5 = e3 ? "\x1B[33m" : "\x1B[31m";
              console.warn(r5 + t3 + "\x1B[0m\n");
            } : l.isNode || "string" != typeof new Error().stack || (s = function(t3, e3) {
          ...
          e3.exports = function(e4, r4, n2, i, o, s) {
            ...
            u.inherits(h, o), h.prototype._isResolved = function() {
              ...
              if (o2 instanceof e4 || null !== (o2 = function(t4, r6, n4) {
                ...
                0 == (50397184 & s2) ? (this._yieldedPromise = o2, o2._proxy(this, null)) : 0 != (33554432 & s2) ? e4._async.invoke(this._promiseFulfilled, this, o2._value()) : 0 != (16777216 & s2) ? e4._async.invoke(this._promiseRejected, this, o2._reason()) : this._promiseCancelled();
              } else
              ...
              if (s.deprecated("Promise.spawn()", "Promise.coroutine()"), "function" != typeof t3)
          ...
          e3.exports = function(e4, r4, n2, i, o, s) {
            ...
            function p(t3, r5, i2, o2) {
              ...
              return new h(t3, r5, s2 = "number" == typeof s2 && isFinite(s2) && s2 >= 1 ? s2 : 0, o2).promise();
            }
            u.inherits(h, r4), h.prototype._asyncInit = function() {
              ...
              if (r5 < 0) {
                ...
                if (s.checkForgottenReturns(d, _, null !== a2 ? "Promise.filter" : "Promise.map", f2), d === l)
          ...
          e3.exports = function(e4) {
            ...
            function a(t3, e5) {
              var r5 = this._boundValue(), s2 = void 0 === t3 ? i(e5).call(r5, null) : i(e5).call(r5, null, t3);
              s2 === o && n2.throwLater(s2.e);
            }
            function u(t3, e5) {
              if (!t3) {
            ...
            e4.prototype.asCallback = e4.prototype.nodeify = function(t3, e5) {
              if ("function" == typeof t3) {
                var r5 = a;
                void 0 !== e5 && Object(e5).spread && (r5 = s), this._then(r5, u, void 0, this, t3);
              }
              return this;
            };
          };
          ...
          r3.exports = function() {
            ...
            return T.prototype.toString = function() {
              ...
              var o2 = void 0 !== i2, s2 = o2 ? i2 : new T(v), u2 = this._target(), l2 = u2._bitField;
              o2 || (s2._propagateFrom(this, 3), s2._captureStackTrace(), void 0 === n4 && 0 != (2097152 & this._bitField) && (n4 = 0 != (50397184 & l2) ? this._boundValue() : u2 === this ? void 0 : this._boundTo), this._fireEvent("promiseChained", this, s2));
              var f2 = a();
              if (0 != (50397184 & l2)) {
                var p2, d2, y2 = u2._settlePromiseCtx;
                0 != (33554432 & l2) ? (d2 = u2._rejectionHandler0, p2 = t3) : 0 != (16777216 & l2) ? (d2 = u2._fulfillmentHandler0, p2 = e3, u2._unsetRejectionIsUnhandled()) : (y2 = u2._settlePromiseLateCancellationObserver, d2 = new _("late cancellation observer"), u2._attachExtraTrace(d2), p2 = e3), h.invoke(y2, u2, { handler: null === f2 ? p2 : "function" == typeof p2 && c.domainBind(f2, p2), promise: s2, receiver: n4, value: d2 });
              } else
              ...
              if (o2 >= 65531 && (o2 = 0, this._setLength(0)), 0 === o2)
                ...
                var s2 = 4 * o2 - 4;
                this[s2 + 2] = r4, this[s2 + 3] = n4, "function" == typeof t3 && (this[s2 + 0] = null === i2 ? t3 : c.domainBind(i2, t3)), "function" == typeof e3 && (this[s2 + 1] = null === i2 ? e3 : c.domainBind(i2, e3));
              }
              ...
              if (0 == (65536 & i2)) {
                ...
                0 == (65536 & (i2 = n4._bitField)) && (o2 === m ? n4._reject(r4) : o2 === R ? n4._rejectCallback(o2.e, false) : (C.checkForgottenReturns(o2, s2, "", n4, this), n4._resolveCallback(o2)));
              }
              ...
              0 != (65536 & a2) ? (o2 && t3._invokeInternalOnCancel(), r4 instanceof x && r4.isFinallyHandler() ? (r4.cancelPromise = t3, k(e3).call(r4, n4) === R && t3._reject(R.e)) : e3 === i ? t3._fulfill(i.call(r4)) : r4 instanceof s ? r4._promiseCancelled(t3) : o2 || t3 instanceof b ? t3._cancel() : r4.cancel()) : "function" == typeof e3 ? o2 ? (u2 && t3._setAsyncGuaranteed(), this._settlePromiseFromHandler(e3, r4, n4, t3)) : e3.call(r4, n4, t3) : r4 instanceof s ? r4._isResolved() || (0 != (33554432 & a2) ? r4._promiseFulfilled(n4, t3) : r4._promiseRejected(n4, t3)) : o2 && (u2 && t3._setAsyncGuaranteed(), 0 != (33554432 & a2) ? t3._fulfill(n4) : t3._reject(n4));
          ...
          e3.exports = function(e4, r4, n2, i, o) {
            ...
            return s.isArray, s.inherits(a, o), a.prototype.length = function() {
              ...
              for (var i2 = this._promise, o2 = false, s2 = null, a2 = 0; a2 < r5; ++a2) {
                var u = n2(t3[a2], i2);
                s2 = u instanceof e4 ? (u = u._target())._bitField : null, o2 ? null !== s2 && u.suppressUnhandledRejections() : null !== s2 ? 0 == (50397184 & s2) ? (u._proxy(this, a2), this._values[a2] = u) : o2 = 0 != (33554432 & s2) ? this._promiseFulfilled(u._value(), a2) : 0 != (16777216 & s2) ? this._promiseRejected(u._reason(), a2) : this._promiseCancelled(a2) : o2 = this._promiseFulfilled(u, a2);
              }
          ...
          e3.exports = function(e4, r4) {
            ...
            function v(t3, e5, r5, n3) {
              for (var o2 = i.inheritedDataKeys(t3), s2 = [], a2 = 0; a2 < o2.length; ++a2) {
                ...
                "function" != typeof l2 || d(l2) || _(t3, u2, e5) || !n3(u2, l2, t3, f2) || s2.push(u2, l2);
              }
            ...
            e4.promisify = function(t3, e5) {
              ...
              if (d(t3))
                return t3;
              var r5 = void 0 === (e5 = Object(e5)).context ? n2 : e5.context, o2 = !!e5.multiArgs, s2 = function(t4, e6, r6) {
              ...
              if ("function" != typeof s2 && (s2 = m), !i.isIdentifier(n3))
                throw new RangeError("suffix must be a valid identifier\n\n    See http://goo.gl/MqrFmX\n");
              for (var a2 = i.inheritedDataKeys(t3), u2 = 0; u2 < a2.length; ++u2) {
                var l2 = t3[a2[u2]];
                "constructor" !== a2[u2] && i.isClass(l2) && (g(l2.prototype, n3, o2, s2, r5), g(l2, n3, o2, s2, r5));
              }
          ...
          e3.exports = function(e4, r4, n2, i, o, s) {
            ...
            function l(t3, r5, n3, i2) {
              this.constructor$(t3);
              var s2 = a();
              this._fn = null === s2 ? r5 : u.domainBind(s2, r5), void 0 !== n3 && (n3 = e4.resolve(n3))._attachCancellationCallback(this), this._initialValue = n3, this._currentCancellable = null, this._eachValues = i2 === o ? Array(this._length) : 0 === i2 ? null : void 0, this._promise._captureStackTrace(), this._init$(void 0, -5);
            }
            function f(t3, e5) {
            ...
            function d(t3) {
              ...
              return s.checkForgottenReturns(r5, a2, void 0 !== n3._eachValues ? "Promise.each" : "Promise.reduce", i2), r5;
            }
          ...
          if (a.isNode && "undefined" == typeof MutationObserver) {
            ...
            s = "undefined" == typeof MutationObserver || "undefined" != typeof window && window.navigator && (window.navigator.standalone || window.cordova) ? void 0 !== n ? function(t3) {
              n(t3);
          ...
          "use strict";
          var o, s = t2("./es5"), a = "undefined" == typeof navigator, u = { e: {} }, c = "undefined" != typeof self ? self : "undefined" != typeof window ? window : void 0 !== r2 ? r2 : void 0 !== this ? this : null;
          function l() {
            try {
              var t3 = o;
          ...
          if ("undefined" != typeof Symbol && Symbol.iterator) {
            ...
            w = function(t3) {
              return s.isArray(t3) ? t3 : null != t3 && "function" == typeof t3[Symbol.iterator] ? E(t3) : null;
            };
          }
          var C = void 0 !== e2 && "[object process]" === b(e2).toLowerCase(), x = void 0 !== e2 && void 0 !== e2.env, j = { isClass: function(t3) {
            try {
              if ("function" == typeof t3) {
                var e3 = s.names(t3.prototype), r3 = s.isES5 && e3.length > 1, n3 = e3.length > 0 && !(1 === e3.length && "constructor" === e3[0]), i2 = d.test(t3 + "") && s.names(t3).length > 0;
                if (r3 || n3 || i2)
                  return true;
              }
              return false;
      ...
      (function(e2, n) {
        ...
        function m(t2, e3) {
          ...
          this.highWaterMark = i2 || 0 === i2 ? i2 : n2 && (s2 || 0 === s2) ? s2 : a2, this.highWaterMark = Math.floor(this.highWaterMark), this.buffer = new _(), this.length = 0, this.pipes = null, this.pipesCount = 0, this.flowing = null, this.ended = false, this.endEmitted = false, this.reading = false, this.sync = true, this.needReadable = false, this.emittedReadable = false, this.readableListening = false, this.resumeScheduled = false, this.destroyed = false, this.defaultEncoding = t2.defaultEncoding || "utf8", this.awaitDrain = 0, this.readingMore = false, this.decoder = null, this.encoding = null, t2.encoding && (d || (d = r(26).StringDecoder), this.decoder = new d(t2.encoding), this.encoding = t2.encoding);
        }
        function g(t2) {
        ...
        function b(t2, e3, r2, n2, i2) {
          ...
          return null === e3 ? (s2.reading = false, function(t3, e4) {
            if (!e4.ended) {
              if (e4.decoder) {
          ...
          }(s2, e3)), o2 ? t2.emit("error", o2) : s2.objectMode || e3 && e3.length > 0 ? ("string" == typeof e3 || s2.objectMode || Object.getPrototypeOf(e3) === c.prototype || (e3 = function(t3) {
            return c.from(t3);
          }(e3)), n2 ? s2.endEmitted ? t2.emit("error", new Error("stream.unshift() after end event")) : w(t2, s2, e3, true) : s2.ended ? t2.emit("error", new Error("stream.push() after EOF")) : (s2.reading = false, s2.decoder && !r2 ? (e3 = s2.decoder.write(e3), s2.objectMode || 0 !== e3.length ? w(t2, s2, e3, false) : S(t2, s2)) : w(t2, s2, e3, false))) : n2 || (s2.reading = false)), function(t3) {
          ...
          return 0 === e3.length ? null : (e3.objectMode ? r2 = e3.buffer.shift() : !t2 || t2 >= e3.length ? (r2 = e3.decoder ? e3.buffer.join("") : 1 === e3.buffer.length ? e3.buffer.head.data : e3.buffer.concat(e3.length), e3.buffer.clear()) : r2 = function(t3, e4, r3) {
            ...
            return t3 < e4.head.data.length ? (n2 = e4.head.data.slice(0, t3), e4.head.data = e4.head.data.slice(t3)) : n2 = t3 === e4.head.data.length ? e4.shift() : r3 ? function(t4, e5) {
              ...
              for (t4 -= i2.length; r4 = r4.next; ) {
                ...
                if (s2 === o2.length ? i2 += o2 : i2 += o2.slice(0, t4), 0 == (t4 -= s2)) {
              ...
              for (n3.data.copy(r4), t4 -= n3.data.length; n3 = n3.next; ) {
                ...
                if (o2.copy(r4, r4.length - t4, 0, s2), 0 == (t4 -= s2)) {
        ...
        g.prototype.read = function(t2) {
          ...
          return -1 === s2 ? this : (e3.pipes.splice(s2, 1), e3.pipesCount -= 1, 1 === e3.pipesCount && (e3.pipes = e3.pipes[0]), t2.emit("unpipe", this, r2), this);
          ...
          for (var i2 in t2.on("end", function() {
            ...
            void 0 === this[i2] && "function" == typeof t2[i2] && (this[i2] = /* @__PURE__ */ function(e4) {
              return function() {
      ...
      e.StringDecoder = o, o.prototype.write = function(t2) {
        ...
        var r2 = function(t3, e3, r3) {
          ...
          if (n3 < r3)
            return 0;
          var i2 = s(e3[n3]);
          return i2 >= 0 ? (i2 > 0 && (t3.lastNeed = i2 - 1), i2) : --n3 < r3 || -2 === i2 ? 0 : (i2 = s(e3[n3])) >= 0 ? (i2 > 0 && (t3.lastNeed = i2 - 2), i2) : --n3 < r3 || -2 === i2 ? 0 : (i2 = s(e3[n3])) >= 0 ? (i2 > 0 && (2 === i2 ? i2 = 0 : t3.lastNeed = i2 - 3), i2) : 0;
        }(this, t2, e2);
        if (!this.lastNeed)
      ...
      function o(t2) {
        ...
        }).bind(this), needTransform: false, transforming: false, writecb: null, writechunk: null, writeencoding: null }, this._readableState.needReadable = true, this._readableState.sync = false, t2 && ("function" == typeof t2.transform && (this._transform = t2.transform), "function" == typeof t2.flush && (this._flush = t2.flush)), this.on("prefinish", s);
      }
      function s() {
        var t2 = this;
      ...
      t.exports = function(t2) {
        return null == t2 ? void 0 === t2 ? "[object Undefined]" : "[object Null]" : s && s in Object(t2) ? i(t2) : o(t2);
      };
    }, function(t, e) {
      t.exports = function(t2, e2) {
      ...
      r(2)(i, n), i.Readable = r(13), i.Writable = r(46), i.Duplex = r(47), i.Transform = r(48), i.PassThrough = r(49), i.Stream = i, i.prototype.pipe = function(t2, e2) {
        ...
        function u() {
          s || (s = true, "function" == typeof t2.destroy && t2.destroy());
        }
        function c(t3) {
      ...
      e.byteLength = function(t2) {
        ...
        return 2 === s2 && (e2 = i[t2.charCodeAt(f2)] << 2 | i[t2.charCodeAt(f2 + 1)] >> 4, a2[u2++] = 255 & e2), 1 === s2 && (e2 = i[t2.charCodeAt(f2)] << 10 | i[t2.charCodeAt(f2 + 1)] << 4 | i[t2.charCodeAt(f2 + 2)] >> 2, a2[u2++] = e2 >> 8 & 255, a2[u2++] = 255 & e2), a2;
      ...
      e.read = function(t2, e2, r, n, i) {
        ...
        var s, a, u, c = 8 * o - i - 1, l = (1 << c) - 1, f = l >> 1, h = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = n ? 0 : o - 1, d = n ? 1 : -1, _ = e2 < 0 || 0 === e2 && 1 / e2 < 0 ? 1 : 0;
      ...
      (function(t2) {
        ...
        var o = r(53), s = i(r(15)), a = r(54), u = i(r(16)), c = r(57), l = r(28), f = r(58), h = i(r(59)), p = i(r(29)), d = function(e2) {
          ...
          return n(r2, e2), r2.prototype.flush = function() {
            ...
            var r3, n2 = this;
            return void 0 === e3 && (e3 = false), r3 = e3 ? t3.toString() : a.prepareData(t3, this.converter.parseRuntime), s.default.resolve().then(function() {
      ...
      var i = n(r(16)), o = r(28), s = [",", "|", "	", ";", ":"], a = function() {
        ...
        return Object.defineProperty(t2.prototype, "needEmitDelimiter", { get: function() {
          ...
          for (var e2 = [], r2 = ""; t3.length; ) {
            ...
            0 === s2.cells.length && this.conv.parseParam.ignoreEmpty || (s2.closed || this.conv.parseParam.alwaysSplitAtEOL ? (this.conv.parseRuntime.selectedColumns ? e2.push(o.filterArray(s2.cells, this.conv.parseRuntime.selectedColumns)) : e2.push(s2.cells), r2 = "") : r2 = n2 + (i.default(n2, this.conv.parseRuntime) || "\n"));
          }
      ...
      function v(t2) {
        var e2 = t2.trim();
        return "" === e2 ? _(t2) : s.test(e2) ? d(t2) : 5 === e2.length && "false" === e2.toLowerCase() || 4 === e2.length && "true" === e2.toLowerCase() ? function(t3) {
          var e3 = t3.trim();
      ...
      t.exports = function(t2, e2, r2, u) {
        ...
        for (var c = -1, l = (e2 = i(e2, t2)).length, f = l - 1, h = t2; null != h && ++c < l; ) {
          ...
          if (c != f) {
            var _ = h[p];
            void 0 === (d = u ? u(_, p, h) : void 0) && (d = s(_) ? _ : o(e2[c + 1]) ? [] : {});
          }
          n(h, p, d), h = h[p];
        }
        return t2;
      ...
      t.exports = function(t2, e2, r2) {
        var s = t2[e2];
        o.call(t2, e2) && i(s, r2) && (void 0 !== r2 || e2 in t2) || n(t2, e2, r2);
      };
    }, function(t, e, r) {
      var n = r(64);
      t.exports = function(t2, e2, r2) {
      ...
      t.exports = function(t2, e2) {
        if (n(t2))
          return false;
        var r2 = typeof t2;
        return !("number" != r2 && "symbol" != r2 && "boolean" != r2 && null != t2 && !i(t2)) || s.test(t2) || !o.test(t2) || null != e2 && t2 in Object(e2);
      };
    }, function(t, e) {
      t.exports = function(t2) {
